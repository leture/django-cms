...
function tree_component () {
	...
	return {
		...
		refresh : function (obj) {
			...
			/*else if(this.settings.cookies && django.jQuery.cookie(this.settings.cookies.prefix + '_selected')) {
				this.settings.selected = Array();
				var str = django.jQuery.cookie(this.settings.cookies.prefix + '_selected');
				var tmp = str.split(",");
				django.jQuery.each(tmp, function () {
